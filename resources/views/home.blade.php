                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="feature-content">
                                <h4 class="feature-title">Smart Classes </h4>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-item active wow fadeInDown" data-wow-delay=".25s">
                            ...
                            <div class="feature-content">
                                <h4 class="feature-title">Library </h4>
                                <p>It is a long established fact that a reader will be distracted.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="feature-content">
                                <h4 class="feature-title">Playground</h4>
                                <p>It is a long established fact that a reader will be distracted.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-item wow fadeInDown" data-wow-delay=".25s">
                            ...
                            <div class="feature-content">
                                <h4 class="feature-title">Computer Labs </h4>
                                <p>It is a long established fact that a reader will be distracted.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-right wow fadeInRight" data-wow-delay=".25s">
                            <div class="site-heading mb-3">
                                ...
                                <h2 class="site-title">
                                    Our Edukation System Inspires You More.
                                </h2>
                            </div>
                            <p class="about-text">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="course-content">
                                <h4 class="course-title pt-4">
                                    <a href="course-single.html">Experienced Faculty</a>
                                </h4>
                                <p class="course-text">
                                    There are many variations of passages orem psum available but the majority have
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="course-content">
                                <h4 class="course-title pt-4">
                                    <a href="course-single.html">Smart Learning</a>
                                </h4>
                                <p class="course-text">
                                    There are many variations of passages orem psum available but the majority have
                                    suffer alteration in some form by injected.
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="course-content">
                                <h4 class="course-title pt-4">
                                    <a href="course-single.html">Sports & Extra-Curriculars</a>
                                </h4>
                                <p class="course-text">
                                    There are many variations of passages orem psum available but the majority have
                                    suffer alteration in some form by injected.
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="course-content">
                                <h4 class="course-title pt-4">
                                    <a href="course-single.html">Well-stocked Library</a>
                                </h4>
                                <p class="course-text">
                                    There are many variations of passages orem psum available but the majority have
                                    suffer alteration in some form by injected.
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="course-content">
                                <h4 class="course-title pt-4">
                                    <a href="course-single.html">Career Guidance & Counseling</a>
                                </h4>
                                <p class="course-text">
                                    There are many variations of passages orem psum available but the majority have
                                    suffer alteration in some form by injected.
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="course-content">
                                <h4 class="course-title pt-4">
                                    <a href="course-single.html">Transport Facility</a>
                                </h4>
                                <p class="course-text">
                                    There are many variations of passages orem psum available but the majority have
                                    suffer alteration in some form by injected.
